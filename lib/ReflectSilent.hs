...
-----------------------------------------------------------------------------
-- |
-- Module      :  XMonad.Layout.ReflectSilent
-- Copyright   :  (c) Brent Yorgey (modified by Flora Xia)
...
-- 
-- Note: the modification was to comment out the description change, so that
-- the name of the layout doesn't show up as "ReflectX [name]" in XMobar
-----------------------------------------------------------------------------

module ReflectSilent (
                               -- * Usage
                               -- $usage
